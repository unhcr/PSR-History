--
-- V_ASR_POC_SUMMARY_DATA
--
create or replace view V_ASR_POC_SUMMARY_DATA as
select ASR_YEAR,
...
--
-- ASR_POC_SUMMARY_DATA
--
create materialized view ASR_POC_SUMMARY_DATA as
select ASR_YEAR,
  ITM_ID_RESIDENCE, COU_CODE_RESIDENCE, ISO3166_ALPHA3_CODE_RESIDENCE,
  ITM_ID_ORIGIN, COU_CODE_ORIGIN, ISO3166_ALPHA3_CODE_ORIGIN,
  RF_VALUE, RF_REDACTED_FLAG, RFA_VALUE, RFA_REDACTED_FLAG,
...
-- ASR_POC_SUMMARY
--
create or replace view ASR_POC_SUMMARY as
select SUM.ASR_YEAR,
