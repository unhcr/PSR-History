...
create synonym S_PERMISSIONS for STAGE.S_PERMISSIONS;
create synonym S_PPGS for STAGE.S_PPGS;
create synonym S_PPG_CORRECTIONS for STAGE.S_PPG_CORRECTIONS;
create synonym S_ROLES for STAGE.S_ROLES;
create synonym S_ROLE_COUNTRIES for STAGE.S_ROLE_COUNTRIES;
