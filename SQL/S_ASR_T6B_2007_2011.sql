create table S_ASR_T6B_2007_2011 
   ...
   (records delimited by newline
    ...
    missing field values are null
     (FILLER1 char(4000),
      ...
      BASIS char(4000))
    column transforms
     (TABLE_NUMBER from constant '6B',
      DISPLACEMENT_CAUSE from constant 'ALL',
      DST_CODE from constant 'IOC'))
  location ('ASR_T6B_2007_2011.csv'))
reject limit unlimited;

grant select on S_ASR_T6B_2007_2011 to PSR_STAGE;
