...
execute P_SYSTEM_PARAMETER.INSERT_SYSTEM_PARAMETER('LOCATION CODE MULTIPLIER', 'en', 'Multiplier used in calculating hashed location code', 'N', pnNUM_VALUE => 43);
execute P_SYSTEM_PARAMETER.INSERT_SYSTEM_PARAMETER('LOCATION CODE INCREMENT', 'en', 'Increment used in calculating hashed location code', 'N', pnNUM_VALUE => 3141592);
