...
CREATE OR REPLACE VIEW POPULATION_CATEGORIES AS
SELECT CODE,
  DESCRIPTION,
  LANG_CODE,
  DISPLAY_SEQ,
...
SELECT T_STATISTIC_TYPES_IN_GROUPS.STCG_CODE,
  T_STATISTIC_TYPES_IN_GROUPS.STCT_CODE,
  T_STATISTIC_TYPES_IN_GROUPS.ITM_ID,
  T_STATISTIC_TYPES_IN_GROUPS.VERSION_NBR
