...
CREATE TABLE LOCATION_RELATIONSHIPS 
    ( 
     LOC_CODE_PARENT NUMBER (10)  NOT NULL , 
     LOC_CODE_CHILD NUMBER (10)  NOT NULL , 
...
ALTER TABLE STATISTICS 
    ADD CONSTRAINT CH_STC_PPG 
    CHECK ((LOC_CODE_PPG is null and PPG_CODE is null and PPG_START_DATE is null) or
(LOC_CODE_PPG is not null and PPG_CODE is not null and PPG_START_DATE is not null))
;


ALTER TABLE STATISTICS 
    ADD CONSTRAINT CH_STC_PER 
    CHECK ((PER_START_DATE is null and PER_END_DATE is null) or
(PER_START_DATE is not null and PER_END_DATE is not null))
;


ALTER TABLE STATISTICS 
    ADD CONSTRAINT CH_STC_AGR 
    CHECK ((AGP_CODE is null and AGE_FROM is null and AGE_TO is null) or
(AGP_CODE is not null and AGE_FROM is not null and AGE_TO is not null))
;
...
ALTER TABLE STATISTICS 
    ADD CONSTRAINT UK_STC UNIQUE ( STCT_CODE , LOC_CODE , LOC_CODE_COUNTRY , LOC_CODE_ORIGIN , LOC_CODE_COUNTRY_ORIGIN , LOC_CODE_PPG , PPG_CODE , PPG_START_DATE , POPC_CODE , PER_START_DATE , PER_END_DATE , SEX , AGP_CODE , AGE_FROM ) ;
...
ALTER TABLE TIME_PERIODS 
    ADD CONSTRAINT PK_PER PRIMARY KEY ( START_DATE, END_DATE ) ;
...
FROM
  ...
  FROM
    (SELECT AGP.CODE,
      ...
      AGP.TXT_ID,
      AGP.VERSION_NBR,
      row_number() OVER (PARTITION BY AGP.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    ...
    SELECT AGP.CODE,
      ...
      AGP.TXT_ID,
      AGP.VERSION_NBR,
      -row_number() OVER (PARTITION BY AGP.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM AGE_PROFILES AGP
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = AGP.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  (SELECT AGP_CODE,
    ...
    TXT_ID,
    VERSION_NBR,
    rank() OVER (PARTITION BY AGP_CODE, AGE_FROM ORDER BY ROW_NUMBER DESC) RANK
  FROM
    (SELECT AGR.AGP_CODE,
      AGR.AGE_FROM,
      AGR.AGE_TO,
      ...
      AGR.TXT_ID,
      AGR.VERSION_NBR,
      row_number() OVER (PARTITION BY AGR.AGP_CODE, AGR.AGE_FROM ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    FROM AGE_RANGES AGR
    INNER JOIN USER_LANGUAGE_PREFERENCES ULP
    ON ULP.USERID = sys_context('PSR', 'USERID')
    INNER JOIN TEXT_ITEMS TXI
    ...
    SELECT AGR.AGP_CODE,
      ...
      AGR.TXT_ID,
      AGR.VERSION_NBR,
      -row_number() OVER (PARTITION BY AGR.AGP_CODE, AGR.AGE_FROM ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM AGE_RANGES AGR
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = AGR.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    ...
    SELECT COMP.CODE,
      ...
      COMP.TXT_ID,
      COMP.VERSION_NBR,
      -row_number() OVER (PARTITION BY COMP.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM COMPONENTS COMP
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = COMP.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
  ...
  FROM
    ...
    FROM
      (SELECT LOC.CODE,
        ...
        LOC.TXT_ID,
        LOC.VERSION_NBR,
        row_number() OVER (PARTITION BY LOC.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
      FROM LOCATIONS LOC
      INNER JOIN USER_LANGUAGE_PREFERENCES ULP
      ON ULP.USERID = sys_context('PSR', 'USERID')
      INNER JOIN TEXT_ITEMS TXI
      ...
      SELECT LOC.CODE,
        ...
        LOC.TXT_ID,
        LOC.VERSION_NBR,
        -row_number() OVER (PARTITION BY LOC.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
      FROM LOCATIONS LOC
      INNER JOIN TEXT_ITEMS TXI
      ON TXI.TXT_ID     = LOC.TXT_ID
      AND TXI.TXTT_CODE = 'NAME'
...
ON LOCR.LOC_CODE_CHILD = LOC.CODE
...
FROM
  ...
  FROM
    ...
    SELECT LANG.CODE,
      ...
      LANG.TXT_ID,
      LANG.VERSION_NBR,
      -row_number() OVER (PARTITION BY LANG.CODE ORDER BY LANG1.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM LANGUAGES LANG
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = LANG.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    (SELECT LOCAT.CODE,
      ...
      LOCAT.TXT_ID,
      LOCAT.VERSION_NBR,
      row_number() OVER (PARTITION BY LOCAT.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    ...
    SELECT LOCAT.CODE,
      ...
      LOCAT.TXT_ID,
      LOCAT.VERSION_NBR,
      -row_number() OVER (PARTITION BY LOCAT.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM LOCATION_ATTRIBUTE_TYPES LOCAT
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = LOCAT.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    (SELECT LOCRT.CODE,
      ...
      LOCRT.TXT_ID,
      LOCRT.VERSION_NBR,
      row_number() OVER (PARTITION BY LOCRT.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    ...
    SELECT LOCRT.CODE,
      ...
      LOCRT.TXT_ID,
      LOCRT.VERSION_NBR,
      -row_number() OVER (PARTITION BY LOCRT.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM LOCATION_RELATIONSHIP_TYPES LOCRT
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = LOCRT.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    (SELECT LOCT.CODE,
      ...
      LOCT.TXT_ID,
      LOCT.VERSION_NBR,
      row_number() OVER (PARTITION BY LOCT.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    ...
    SELECT LOCT.CODE,
      ...
      LOCT.TXT_ID,
      LOCT.VERSION_NBR,
      -row_number() OVER (PARTITION BY LOCT.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM LOCATION_TYPES LOCT
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = LOCT.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    ...
    SELECT MSG.COMP_CODE,
      ...
      MSG.TXT_ID,
      MSG.VERSION_NBR,
      -row_number() OVER (PARTITION BY MSG.COMP_CODE, MSG.SEQ_NBR ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM MESSAGES MSG
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = MSG.TXT_ID
    AND TXI.TXTT_CODE = 'MSG'
...
FROM
  ...
  FROM
    (SELECT POPC.CODE,
      ...
      POPC.TXT_ID,
      POPC.VERSION_NBR,
      row_number() OVER (PARTITION BY POPC.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    ...
    SELECT POPC.CODE,
      ...
      POPC.TXT_ID,
      POPC.VERSION_NBR,
      -row_number() OVER (PARTITION BY POPC.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM POPULATION_CATEGORIES POPC
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = POPC.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    (SELECT STCG.CODE,
      ...
      STCG.TXT_ID,
      STCG.VERSION_NBR,
      row_number() OVER (PARTITION BY STCG.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    ...
    SELECT STCG.CODE,
      ...
      STCG.TXT_ID,
      STCG.VERSION_NBR,
      -row_number() OVER (PARTITION BY STCG.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM STATISTIC_GROUPS STCG
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = STCG.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    (SELECT STCT.CODE,
      ...
      STCT.TXT_ID,
      STCT.VERSION_NBR,
      row_number() OVER (PARTITION BY STCT.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    ...
    SELECT STCT.CODE,
      ...
      STCT.TXT_ID,
      STCT.VERSION_NBR,
      -row_number() OVER (PARTITION BY STCT.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM STATISTIC_TYPES STCT
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = STCT.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    (SELECT SYP.CODE,
      ...
      SYP.TXT_ID,
      SYP.VERSION_NBR,
      row_number() OVER (PARTITION BY SYP.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    ...
    SELECT SYP.CODE,
      ...
      0 ROW_NUMBER
    FROM SYSTEM_PARAMETERS SYP
    INNER JOIN SYSTEM_PARAMETERS SYP1
    ON SYP1.CODE = 'FALLBACK LANGUAGE'
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = SYP.TXT_ID
    AND TXI.LANG_CODE = SYP1.CHAR_VALUE
    AND TXI.TXTT_CODE = 'DESCR'
    AND TXI.SEQ_NBR   = 1
    INNER JOIN LANGUAGES LANG
    ON LANG.CODE         = TXI.LANG_CODE
    ...
    SELECT SYP.CODE,
      ...
      SYP.TXT_ID,
      SYP.VERSION_NBR,
      -row_number() OVER (PARTITION BY SYP.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM SYSTEM_PARAMETERS SYP
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = SYP.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    ...
    SELECT USR.USERID,
      ...
      USR.TXT_ID,
      USR.VERSION_NBR,
      -row_number() OVER (PARTITION BY USR.USERID ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM SYSTEM_USERS USR
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = USR.TXT_ID
    AND TXI.TXTT_CODE = 'NAME'
...
FROM
  ...
  FROM
    ...
    SELECT TXI.TXT_ID,
      ...
      TXI.TEXT,
      TXI.LONG_TEXT,
      -row_number() OVER (PARTITION BY TXI.TXT_ID, TXI.TXTT_CODE, TXI.SEQ_NBR ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM TEXT_ITEMS TXI
    INNER JOIN LANGUAGES LANG
    ON LANG.CODE = TXI.LANG_CODE
    )
...
FROM
  ...
  FROM
    ...
    SELECT TXTT.CODE,
      ...
      TXTT.TXT_ID,
      TXTT.VERSION_NBR,
      -row_number() OVER (PARTITION BY TXTT.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM TEXT_TYPES TXTT
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = TXTT.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    (SELECT PERT.CODE,
      ...
      PERT.TXT_ID,
      PERT.VERSION_NBR,
      row_number() OVER (PARTITION BY PERT.CODE ORDER BY ULP.PREF_SEQ DESC) ROW_NUMBER
    ...
    SELECT PERT.CODE,
      ...
      PERT.TXT_ID,
      PERT.VERSION_NBR,
      -row_number() OVER (PARTITION BY PERT.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM TIME_PERIOD_TYPES PERT
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = PERT.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
...
FROM
  ...
  FROM
    ...
    SELECT UATT.CODE,
      ...
      UATT.TXT_ID,
      UATT.VERSION_NBR,
      -row_number() OVER (PARTITION BY UATT.CODE ORDER BY LANG.ACTIVE_FLAG DESC) ROW_NUMBER
    FROM USER_ATTRIBUTE_TYPES UATT
    INNER JOIN TEXT_ITEMS TXI
    ON TXI.TXT_ID     = UATT.TXT_ID
    AND TXI.TXTT_CODE = 'DESCR'
