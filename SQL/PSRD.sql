...
FROM
  (SELECT AGR.AGP_CODE,
    ...
    AGR.TXT_ID,
    AGR.VERSION_NBR,
    row_number() OVER (PARTITION BY AGR.AGP_CODE, AGR.AGE_FROM ORDER BY LANG.ACTIVE_FLAG, NVL(ULP.PREF_SEQ, LANG.DISPLAY_SEQ + 1e5)) RANK
  FROM AGE_RANGES AGR
  INNER JOIN TEXT_ITEMS TXI
