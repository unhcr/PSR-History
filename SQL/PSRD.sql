...
CREATE TABLE LOCATION_TYPE_VARIANTS 
    ( 
     ID INTEGER  NOT NULL , 
     LOCT_CODE VARCHAR2 (10)  NOT NULL , 
     LOC_CODE NUMBER (10)  NOT NULL , 
...
ALTER TABLE LOCATION_TYPE_VARIANTS 
...
ALTER TABLE LOCATION_TYPE_VARIANTS 
    ADD CONSTRAINT UK_LOCTV_TXT_ID UNIQUE ( TXT_ID ) ;
...
CREATE TABLE STATISTICS 
    ( 
     ...
     LOC_CODE_ASYLUM NUMBER (10)  NOT NULL , 
     LOC_CODE_ORIGIN NUMBER (10) , 
     LOC_CODE_SOURCE NUMBER (10) , 
     PPG_ID INTEGER , 
...
ALTER TABLE STATISTICS 
    ADD CONSTRAINT UK_STC UNIQUE ( STCT_CODE , LOC_CODE_ASYLUM , LOC_CODE_COUNTRY , LOC_CODE_ORIGIN , LOC_CODE_SOURCE , PPG_ID , POPC_CODE , PER_ID , SEX_CODE , AGR_ID , DIM_ID1 , DIM_ID2 , DIM_ID3 , DIM_ID4 , DIM_ID5 ) ;
...
ALTER TABLE LOCATION_TYPE_VARIANTS 
    ADD CONSTRAINT FK_LOCTV_TXT FOREIGN KEY 
    ( 
     TXT_ID
    ) 
    REFERENCES TEXT_HEADERS 
...
ALTER TABLE LOCATIONS 
    ...
    REFERENCES LOCATION_TYPE_VARIANTS 
    ( 
     ID
    ) 
;
