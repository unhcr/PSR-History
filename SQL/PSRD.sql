...
ALTER TABLE STATISTICS 
    ADD CONSTRAINT UK_STC UNIQUE ( STCT_CODE , LOC_CODE , LOC_CODE_COUNTRY , LOC_CODE_ORIGIN , LOC_CODE_COUNTRY_ORIGIN , LOC_CODE_PPG , PPG_CODE , PPG_START_DATE , POPC_CODE , PER_ID , SEX , AGP_CODE , AGE_FROM ) ;
...
CREATE INDEX PSR.IX_PER_PARENT ON TIME_PERIODS 
    ( 
     PER_ID_PARENT ASC 
    ) 
;
