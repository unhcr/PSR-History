...
CREATE TABLE T_POPSEG_ATTRIBUTES 
    ( 
     PSG_ID INTEGER  NOT NULL , 
     PSGAT_CODE VARCHAR2 (10)  NOT NULL , 
     CHAR_VALUE VARCHAR2 (1000) , 
     NUM_VALUE NUMBER , 
     DATE_VALUE DATE , 
     ITM_ID INTEGER , 
...
ALTER TABLE T_POPSEG_ATTRIBUTES 
    ADD CONSTRAINT CH_PSGA 
    CHECK ((CHAR_VALUE is not null and NUM_VALUE is null and DATE_VALUE is null) or
(CHAR_VALUE is null and NUM_VALUE is not null and DATE_VALUE is null) or
(CHAR_VALUE is null and NUM_VALUE is null and DATE_VALUE is not null))
;
...
ALTER TABLE T_POPSEG_ATTRIBUTES 
    ADD CONSTRAINT PK_PSGA PRIMARY KEY ( PSG_ID, PSGAT_CODE ) ;


ALTER TABLE T_POPSEG_ATTRIBUTES 
    ADD CONSTRAINT UK_PSGA_ITM_ID UNIQUE ( ITM_ID ) ;



CREATE TABLE T_POPSEG_ATTRIBUTE_TYPES 
    ( 
     CODE VARCHAR2 (10)  NOT NULL , 
     DATA_TYPE VARCHAR2 (1)  NOT NULL , 
     DISPLAY_SEQ NUMBER (5) , 
...
ALTER TABLE T_POPSEG_ATTRIBUTE_TYPES 
    ADD CONSTRAINT CH_PSGAT_CODE 
    CHECK ( CODE = trim(upper(CODE))) 
;


ALTER TABLE T_POPSEG_ATTRIBUTE_TYPES 
    ADD CONSTRAINT CH_PSGAT_DATA_TYPE 
    CHECK ( DATA_TYPE IN ('C', 'D', 'N')) 
;


ALTER TABLE T_POPSEG_ATTRIBUTE_TYPES 
    ADD CONSTRAINT CH_PSGAT_ACTIVE_FLAG 
    CHECK ( ACTIVE_FLAG IN ('N', 'Y')) 
;


ALTER TABLE T_POPSEG_ATTRIBUTE_TYPES 
    ADD CONSTRAINT PK_PSGAT PRIMARY KEY ( CODE ) ;


ALTER TABLE T_POPSEG_ATTRIBUTE_TYPES 
    ADD CONSTRAINT UK_PSGAT_ITM_ID UNIQUE ( ITM_ID ) ;
...
CREATE TABLE T_POPULATION_SEGMENTS 
    ( 
     ID INTEGER  NOT NULL , 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT CH_PSG_ID 
    CHECK ( ID > 0) 
;

CREATE UNIQUE INDEX IX_PSG ON T_POPULATION_SEGMENTS 
    ( 
     DST_CODE, nvl(LOC_ID_COUNTRY, 0), nvl(LOC_ID_ORIGIN, 0), nvl(LOC_ID_ASYLUM, 0), nvl(LOC_ID_SOURCE, 0), nvl(DIM_ID1, 0), nvl(DIM_ID2, 0), nvl(DIM_ID3, 0), nvl(DIM_ID4, 0), nvl(DIM_ID5, 0), SEQ_NBR
    ) 
;

ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT PK_PSG PRIMARY KEY ( ID ) ;


ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT UK_PSG_ITM_ID UNIQUE ( ITM_ID ) ;
...
ALTER TABLE T_STATISTICS 
    ADD CONSTRAINT UK_STC UNIQUE ( PSG_ID , STCT_CODE , PER_ID , SEX_CODE , AGR_ID ) ;
...
ALTER TABLE T_POPSEG_ATTRIBUTE_TYPES 
    ADD CONSTRAINT FK_PSGAT_ITM FOREIGN KEY 
    ( 
     ITM_ID
    ) 
    REFERENCES T_DATA_ITEMS 
...
ALTER TABLE T_POPSEG_ATTRIBUTES 
    ADD CONSTRAINT FK_PSGA_ITM FOREIGN KEY 
    ( 
     ITM_ID
    ) 
    REFERENCES T_DATA_ITEMS 
...
ALTER TABLE T_POPSEG_ATTRIBUTES 
    ADD CONSTRAINT FK_PSGA_PSG FOREIGN KEY 
    ( 
     PSG_ID
    ) 
    REFERENCES T_POPULATION_SEGMENTS 
    ( 
     ID
    ) 
    ON DELETE CASCADE 
...
ALTER TABLE T_POPSEG_ATTRIBUTES 
    ADD CONSTRAINT FK_PSGA_PSGAT FOREIGN KEY 
    ( 
     PSGAT_CODE
    ) 
    REFERENCES T_POPSEG_ATTRIBUTE_TYPES 
    ( 
     CODE
    ) 
;
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_DIM1 FOREIGN KEY 
    ( 
     DIM_ID1
    ) 
    REFERENCES T_DIMENSION_VALUES 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_DIM2 FOREIGN KEY 
    ( 
     DIM_ID2
    ) 
    REFERENCES T_DIMENSION_VALUES 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_DIM3 FOREIGN KEY 
    ( 
     DIM_ID3
    ) 
    REFERENCES T_DIMENSION_VALUES 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_DIM4 FOREIGN KEY 
    ( 
     DIM_ID4
    ) 
    REFERENCES T_DIMENSION_VALUES 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_DIM5 FOREIGN KEY 
    ( 
     DIM_ID5
    ) 
    REFERENCES T_DIMENSION_VALUES 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_DST FOREIGN KEY 
    ( 
     DST_CODE
    ) 
    REFERENCES T_DISPLACEMENT_STATUSES 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_ITM FOREIGN KEY 
    ( 
     ITM_ID
    ) 
    REFERENCES T_DATA_ITEMS 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_LOC_ASYLUM FOREIGN KEY 
    ( 
     LOC_ID_ASYLUM
    ) 
    REFERENCES T_LOCATIONS 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_LOC_COUNTRY FOREIGN KEY 
    ( 
     LOC_ID_COUNTRY
    ) 
    REFERENCES T_LOCATIONS 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_LOC_ORIGIN FOREIGN KEY 
    ( 
     LOC_ID_ORIGIN
    ) 
    REFERENCES T_LOCATIONS 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_LOC_SOURCE FOREIGN KEY 
    ( 
     LOC_ID_SOURCE
    ) 
    REFERENCES T_LOCATIONS 
...
ALTER TABLE T_POPULATION_SEGMENTS 
    ADD CONSTRAINT FK_PSG_PPG FOREIGN KEY 
    ( 
     PPG_ID
    ) 
    REFERENCES T_POPULATION_PLANNING_GROUPS 
...
ALTER TABLE T_STATISTICS 
    ADD CONSTRAINT FK_STC_PSG FOREIGN KEY 
    ( 
     PSG_ID
    ) 
    REFERENCES T_POPULATION_SEGMENTS 
...
CREATE OR REPLACE VIEW POPULATION_SEGMENTS AS
SELECT ID,
  DST_CODE,
  DST_DESCRIPTION,
  LOC_ID_COUNTRY,
...
FROM
  (SELECT PSG.ID,
    ...
    PSG.SEQ_NBR,
    TXT.TEXT AS SUB_SEGMENT_NAME,
    PSG.PPG_ID,
    PPG.DESCRIPTION AS PPG_DESCRIPTION,
    PSG.ITM_ID,
    PSG.VERSION_NBR
  FROM T_POPULATION_SEGMENTS PSG
  LEFT OUTER JOIN DISPLACEMENT_STATUSES DST
  ON DST.CODE = PSG.DST_CODE
  LEFT OUTER JOIN LOCATIONS LOC1
  ON LOC1.ID = PSG.LOC_ID_COUNTRY
  ...
  LEFT OUTER JOIN LOCATIONS LOC2
  ON LOC2.ID = PSG.LOC_ID_ASYLUM
  LEFT OUTER JOIN LOCATION_TYPES LOCT
  ON LOCT.CODE = LOC2.LOCT_CODE
  LEFT OUTER JOIN LOCATION_TYPE_VARIANTS LOCTV
  ON LOCTV.ID = LOC2.LOCTV_ID
  LEFT OUTER JOIN LOCATIONS LOC3
  ON LOC3.ID = PSG.LOC_ID_ORIGIN
  ...
  AND LOCA4.LOCAT_CODE = 'HCRCC'
  LEFT OUTER JOIN LOCATIONS LOC4
  ON LOC4.ID = PSG.LOC_ID_SOURCE
  LEFT OUTER JOIN DIMENSION_VALUES DIM1
  ON DIM1.ID = PSG.DIM_ID1
  LEFT OUTER JOIN DIMENSION_TYPES DIMT1
  ON DIMT1.CODE = DIM1.DIMT_CODE
  LEFT OUTER JOIN DIMENSION_VALUES DIM2
  ON DIM2.ID = PSG.DIM_ID2
  LEFT OUTER JOIN DIMENSION_TYPES DIMT2
  ON DIMT2.CODE = DIM2.DIMT_CODE
  LEFT OUTER JOIN DIMENSION_VALUES DIM3
  ON DIM3.ID = PSG.DIM_ID3
  LEFT OUTER JOIN DIMENSION_TYPES DIMT3
  ON DIMT3.CODE = DIM3.DIMT_CODE
  LEFT OUTER JOIN DIMENSION_VALUES DIM4
  ON DIM4.ID = PSG.DIM_ID4
  LEFT OUTER JOIN DIMENSION_TYPES DIMT4
  ON DIMT4.CODE = DIM4.DIMT_CODE
  LEFT OUTER JOIN DIMENSION_VALUES DIM5
  ON DIM5.ID = PSG.DIM_ID5
  LEFT OUTER JOIN DIMENSION_TYPES DIMT5
  ON DIMT5.CODE = DIM5.DIMT_CODE
  LEFT OUTER JOIN POPULATION_PLANNING_GROUPS PPG
  ON PPG.ID = PSG.PPG_ID
  LEFT OUTER JOIN TEXT_ITEMS TXT
  ON TXT.ITM_ID     = PSG.ITM_ID
  AND TXT.TXTT_CODE = 'PSSGNAME'
  AND TXT.SEQ_NBR   = 1
  ) ;
...
FROM
  (SELECT STC.ID,
    ...
    STC.PER_ID,
    PER.START_DATE   AS PER_START_DATE,
    PER.END_DATE     AS PER_END_DATE,
    PERT.DESCRIPTION AS PERT_DESCRIPTION,
    STC.SEX_CODE,
...
SELECT LOC_ID_COUNTRY,
  ...
  ASYLUM_SEEKERS,
  ASYLUM_SEEKERS_ASSISTED,
  IDPS,
  IDPS_ASSISTED,
  IDP_LIKE,
  IDP_LIKE_ASSISTED,
  RETURNED_IDPS,
  RETURNED_IDPS_ASSISTED,
  STATELESS,
  STATELESS_ASSISTED,
  OTHERS,
  OTHERS_ASSISTED
FROM
  (SELECT STC.LOC_ID_COUNTRY,
    STC.LOC_NAME_COUNTRY,
    STC.ISO_COUNTRY_CODE,
    STC.UNHCR_COUNTRY_CODE,
    STC.LOC_ID_ORIGIN,
    STC.LOC_NAME_ORIGIN,
    STC.ISO_ORIGIN_CODE,
    STC.UNHCR_ORIGIN_CODE,
    SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'REF', STC.VALUE))) REFUGEES,
    SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'REF', STC.VALUE))) REFUGEES_ASSISTED,
    SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'ROC', STC.VALUE))) REFUGEE_LIKE,
    SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'ROC', STC.VALUE))) REFUGEE_LIKE_ASSISTED,
    SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'ASY', STC.VALUE))) ASYLUM_SEEKERS,
    SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'ASY', STC.VALUE))) ASYLUM_SEEKERS_ASSISTED,
    SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'IDP', STC.VALUE))) IDPS,
    SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'IDP', STC.VALUE))) IDPS_ASSISTED,
    SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'IOC', STC.VALUE))) IDP_LIKE,
    SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'IOC', STC.VALUE))) IDP_LIKE_ASSISTED,
    SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'RDP', STC.VALUE))) RETURNED_IDPS,
    SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'RDP', STC.VALUE))) RETURNED_IDPS_ASSISTED,
    SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'STA', STC.VALUE))) STATELESS,
    SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'STA', STC.VALUE))) STATELESS_ASSISTED,
    SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'OOC', STC.VALUE))) OTHERS,
    SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'OOC', STC.VALUE))) OTHERS_ASSISTED
  FROM STATISTICS STC
  WHERE STC.DST_CODE IN ('REF', 'ROC', 'ASY', 'IDP', 'IOC', 'RDP', 'STA', 'OOC')
  GROUP BY STC.LOC_ID_COUNTRY,
    STC.LOC_NAME_COUNTRY,
    STC.ISO_COUNTRY_CODE,
    STC.UNHCR_COUNTRY_CODE,
    STC.LOC_ID_ORIGIN,
...
FROM
  (SELECT LOC_ID_COUNTRY,
    ...
    REPATRIATED,
    REPATRIATED_ASSISTED,
    greatest(NVL(RETURNEES, REPATRIATED), NVL(REPATRIATED, RETURNEES)) RETURNED,
    greatest(NVL(RETURNEES_ASSISTED, REPATRIATED_ASSISTED), NVL(REPATRIATED_ASSISTED, RETURNEES_ASSISTED)) RETURNED_ASSISTED
  FROM
    (SELECT STC.LOC_ID_COUNTRY,
      LOC_NAME_COUNTRY,
      ISO_COUNTRY_CODE,
      ...
      ISO_ORIGIN_CODE,
      UNHCR_ORIGIN_CODE,
      SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'RET', STC.VALUE))) RETURNEES,
      SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'RET', STC.VALUE))) RETURNEES_ASSISTED,
      SUM(DECODE(STC.STCT_CODE, 'POCPOP', DECODE(STC.DST_CODE, 'RPT', STC.VALUE))) REPATRIATED,
      SUM(DECODE(STC.STCT_CODE, 'POCASSIST', DECODE(STC.DST_CODE, 'RPT', STC.VALUE))) REPATRIATED_ASSISTED
    FROM STATISTICS STC
    WHERE STC.DST_CODE IN ('RET', 'RPT')
    GROUP BY STC.LOC_ID_COUNTRY,
      LOC_NAME_COUNTRY,
      ISO_COUNTRY_CODE,
      UNHCR_COUNTRY_CODE,
...
CREATE OR REPLACE VIEW UP_ASR_TABLE2 AS
SELECT STATSYEAR,
  DST_CODE,
  DST_DESCRIPTION,
  ISO_COUNTRY_CODE,
  ...
  BASIS
FROM
  (SELECT Extract(YEAR FROM STC.PER_START_DATE) AS STATSYEAR,
    STC.DST_CODE,
    STC.DST_DESCRIPTION,
    STC.ISO_COUNTRY_CODE,
    STC.UNHCR_COUNTRY_CODE,
    ...
    ||
    CASE
      WHEN STC.PERT_DESCRIPTION = 'Year'
      THEN ''
      WHEN STC.PER_START_DATE = TRUNC(STC.PER_START_DATE, 'YYYY')
      THEN '_START'
      WHEN STC.PER_END_DATE = add_months(TRUNC(STC.PER_START_DATE, 'YYYY'), 12)
      THEN '_END'
    END AS COLUMN_NAME,
    STC.VALUE,
    STC.ID           AS STC_ID,
    STC.ITM_ID       AS ITM_ID,
    PSGA1.CHAR_VALUE AS SOURCE,
    PSGA2.CHAR_VALUE AS BASIS
  FROM STATISTICS STC
  LEFT OUTER JOIN T_POPSEG_ATTRIBUTES PSGA1
  ON PSGA1.PSG_ID      = STC.PSG_ID
  AND PSGA1.PSGAT_CODE = 'SOURCE'
  LEFT OUTER JOIN T_POPSEG_ATTRIBUTES PSGA2
  ON PSGA2.PSG_ID      = STC.PSG_ID
  AND PSGA2.PSGAT_CODE = 'BASIS'
  WHERE STC.DST_CODE  IN ('REF', 'ROC')
  AND STC.STCT_CODE   IN ('POP', 'POP-AH', 'ARR-GRP', 'ARR-IND', 'ARR-RESTL', 'BIRTH', 'REFOTHINC', 'VOLREP', 'VOLREP-AH', 'RESTL', 'RESTL-AH', 'CESSATION', 'NATURLZN', 'DEATH', 'REFOTHDEC')
  AND STC.DIM_ID1     IS NULL
  AND STC.DIM_ID2     IS NULL
  AND STC.DIM_ID3     IS NULL
  AND STC.DIM_ID4     IS NULL
  AND STC.DIM_ID5     IS NULL
  AND STC.SEX_CODE    IS NULL
  AND STC.AGR_ID      IS NULL
  ) ;
