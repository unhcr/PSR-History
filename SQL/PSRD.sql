...
ALTER TABLE T_STATISTICS 
    ADD CONSTRAINT UK_STC UNIQUE ( STCT_CODE , LOC_ID_ASYLUM , LOC_ID_COUNTRY , LOC_ID_ORIGIN , LOC_ID_SOURCE , PPG_ID , DST_CODE , PER_ID , SEX_CODE , AGR_ID , DIM_ID1 , DIM_ID2 , DIM_ID3 , DIM_ID4 , DIM_ID5 ) ;
