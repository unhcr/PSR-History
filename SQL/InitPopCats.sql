...
execute P_POPULATION_CATEGORY.INSERT_POPULATION_CATEGORY('RDP', 'en', '(?) Returnee internally displaced persons');
...
execute P_POPULATION_CATEGORY.INSERT_POPULATION_CATEGORY('STA', 'en', 'Stateless');
