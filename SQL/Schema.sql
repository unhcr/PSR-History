...
ALTER TABLE T_STATISTICS 
    ADD CONSTRAINT UK_STC UNIQUE ( STCT_CODE , START_DATE , END_DATE , DST_CODE , LOC_ID_ASYLUM_COUNTRY , LOC_ID_ASYLUM , LOC_ID_ORIGIN_COUNTRY , LOC_ID_ORIGIN , DIM_ID1 , DIM_ID2 , DIM_ID3 , DIM_ID4 , DIM_ID5 , SEX_CODE , AGR_ID , PGR_ID_SUBGROUP ) ;
...
ALTER TABLE T_STATISTICS 
    ADD CONSTRAINT FK_STC_PGR_SUBGROUP FOREIGN KEY 
    ( 
     PGR_ID_SUBGROUP
    ) 
    REFERENCES T_POPULATION_GROUPS 
