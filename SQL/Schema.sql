...
SELECT ISO_COUNTRY_CODE,
  ...
  LOCATION_END_DATE
FROM
  (SELECT LOCA1.CHAR_VALUE AS ISO_COUNTRY_CODE,
...
FROM
  (SELECT Extract(YEAR FROM STC.START_DATE) AS STATSYEAR,
    ...
    NVL(LOCA3.CHAR_VALUE, LOCA4.CHAR_VALUE) AS ORIGIN_CODE,
    PPG.PPG_CODE,
    STC.SEX_CODE,
    AGR.AGE_FROM,
    AGR.AGE_TO,
  ...
  LEFT OUTER JOIN T_LOCATION_ATTRIBUTES LOCA4
  ON LOCA4.LOC_ID      = STC.LOC_ID_ORIGIN_COUNTRY
  AND LOCA4.LOCAT_CODE = 'HCRCC'
