...
CREATE UNIQUE INDEX IX_PGR ON T_POPULATION_GROUPS 
    ( 
     START_DATE, END_DATE, nvl(DST_ID, 0), nvl(LOC_ID_ASYLUM_COUNTRY, 0), nvl(LOC_ID_ORIGIN_COUNTRY, 0), nvl(LOC_ID_ASYLUM, 0), nvl(LOC_ID_ORIGIN, 0), nvl(DIM_ID1, 0), nvl(DIM_ID2, 0), nvl(DIM_ID3, 0), nvl(DIM_ID4, 0), nvl(DIM_ID5, 0), nvl(SEX_CODE, 'x'), nvl(AGR_ID, 0), SEQ_NBR
    ) 
;
...
ALTER TABLE T_STATISTICS 
    ADD CONSTRAINT UK_STC UNIQUE ( STCT_CODE , START_DATE , END_DATE , DST_ID , LOC_ID_ASYLUM_COUNTRY , LOC_ID_ASYLUM , LOC_ID_ORIGIN_COUNTRY , LOC_ID_ORIGIN , DIM_ID1 , DIM_ID2 , DIM_ID3 , DIM_ID4 , DIM_ID5 , SEX_CODE , AGR_ID , PGR_SEQ_NBR ) ;
