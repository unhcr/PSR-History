...
execute :SEQ_NBR := null /* 14 */; MESSAGE.INSERT_MESSAGE('TXT', :SEQ_NBR, 'en', 'Text message already exists');
execute :SEQ_NBR := null /* 15 */; MESSAGE.INSERT_MESSAGE('TXT', :SEQ_NBR, 'en', 'Text message must be specified');
