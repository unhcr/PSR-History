...
execute :SEQ_NBR := null /* 1 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Message not found', 'S');
execute MESSAGE.SET_MSG_MESSAGE('MSG', :SEQ_NBR, 'fr', 'Message introuvable');
execute :SEQ_NBR := null /* 2 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Invalid severity', 'S');
execute MESSAGE.SET_MSG_MESSAGE('MSG', :SEQ_NBR, 'fr', unistr('S\00E9v\00E9rit\00E9 invalide'));
execute :SEQ_NBR := null /* 3 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'English message not found', 'S');
execute MESSAGE.SET_MSG_MESSAGE('MSG', :SEQ_NBR, 'fr', 'Message anglais introuvable');
execute :SEQ_NBR := null /* 4 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'English message mismatch', 'S');
execute MESSAGE.SET_MSG_MESSAGE('MSG', :SEQ_NBR, 'fr', unistr('Disparit\00E9 de message anglais'));
execute :SEQ_NBR := null /* 5 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Description must be specified for new component');
execute :SEQ_NBR := null /* 6 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Description language cannot be specified without description text');
execute :SEQ_NBR := null /* 7 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Nothing to be updated');
execute :SEQ_NBR := null /* 8 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Unknown description language');
execute :SEQ_NBR := null /* 9 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Inactive description language');
execute :SEQ_NBR := null /* 10 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Component does not exist');
execute :SEQ_NBR := null /* 11 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Text type must be specified');
execute :SEQ_NBR := null /* 12 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Message text must be specified for new message');
execute :SEQ_NBR := null /* 13 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Message language cannot be specified without message text');
execute :SEQ_NBR := null /* 14 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Unknown message language');
execute :SEQ_NBR := null /* 15 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Inactive message language');
execute :SEQ_NBR := null /* 16 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Message sequence number greater than current maximum');
execute :SEQ_NBR := null /* 17 */; MESSAGE.SET_MESSAGE('MSG', :SEQ_NBR, 'en', 'Message does not exist');
