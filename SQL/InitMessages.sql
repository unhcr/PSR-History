...
execute :MSG_SEQ_NBR := null /* 5 */; P_MESSAGE.INSERT_MESSAGE('TXT', :MSG_SEQ_NBR, 'en', 'Cannot specify a text item sequence number without a data item identifier');
execute :MSG_SEQ_NBR := null /* 6 */; P_MESSAGE.INSERT_MESSAGE('TXT', :MSG_SEQ_NBR, 'en', 'Wrong table for this data item identifier');
