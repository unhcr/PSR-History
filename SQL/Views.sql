...
with Q_ASR_TABLE2 as
 (select STATSYEAR, DST_ID, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY, PGR_ID_PRIMARY,
  ...
  from
   (select to_char(extract(year from STC.START_DATE)) as STATSYEAR, STC.DST_ID,
...
with Q_ASR_TABLE3 as
 (select STATSYEAR, DST_ID,
  ...
  from
   (select extract(year from STC.START_DATE) as STATSYEAR, STC.DST_ID,
...
with Q_ASR_TABLE4 as
 (select STATSYEAR, DST_ID, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY,
...
with Q_ASR_TABLE6AB as
 (select STATSYEAR, DST_ID, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ASYLUM, DIM_ID1, PGR_ID_PRIMARY,
...
with Q_ASR_TABLE7C as
 (select STATSYEAR, LOC_ID_ASYLUM_COUNTRY, PGR_ID_PRIMARY,
...
with Q_ASR_TABLE7D as
 (select STATSYEAR, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY, PGR_ID_PRIMARY,
...
with Q_STATISTICS as
 (select STATSYEAR, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY,
  ...
  from
   (select cast(to_char(extract(year from STC.START_DATE)) as varchar2(4)) as STATSYEAR,
      STC.LOC_ID_ASYLUM_COUNTRY, STC.LOC_ID_ORIGIN_COUNTRY,
