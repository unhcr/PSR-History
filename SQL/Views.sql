...
select AT5.ASR_YEAR,
  ...
  cast(LOCA4.CHAR_VALUE as varchar2(3)) as UNHCR_ORIGIN_CODE,
  LOC2.NAME as LOC_NAME_ORIGIN_COUNTRY,
  AT5.STG_ID_PRIMARY, STG.VERSION_NBR as STG_VERSION_NBR, STG.ITM_ID as STG_ITM_ID,
  AT5.ASYPOP_START_VALUE, AT5.ASYPOP_START_STC_ID, AT5.ASYPOP_START_VERSION_NBR,
  AT5.ASYPOP_START_ITM_ID,
  AT5.ASYPOP_AH_START_VALUE, AT5.ASYPOP_AH_START_STC_ID, AT5.ASYPOP_AH_START_VERSION_NBR,
  AT5.ASYPOP_AH_START_ITM_ID,
  AT5.ASYAPP_VALUE, AT5.ASYAPP_STC_ID, AT5.ASYAPP_VERSION_NBR, AT5.ASYAPP_ITM_ID,
  AT5.ASYREC_CV_VALUE, AT5.ASYREC_CV_STC_ID, AT5.ASYREC_CV_VERSION_NBR, AT5.ASYREC_CV_ITM_ID,
  AT5.ASYREC_CP_VALUE, AT5.ASYREC_CP_STC_ID, AT5.ASYREC_CP_VERSION_NBR, AT5.ASYREC_CP_ITM_ID,
  AT5.ASYREJ_VALUE, AT5.ASYREJ_STC_ID, AT5.ASYREJ_VERSION_NBR, AT5.ASYREJ_ITM_ID,
  AT5.ASYOTHCL_VALUE, AT5.ASYOTHCL_STC_ID, AT5.ASYOTHCL_VERSION_NBR, AT5.ASYOTHCL_ITM_ID,
  AT5.ASYPOP_END_VALUE, AT5.ASYPOP_END_STC_ID, AT5.ASYPOP_END_VERSION_NBR, AT5.ASYPOP_END_ITM_ID,
  AT5.ASYPOP_AH_END_VALUE, AT5.ASYPOP_AH_END_STC_ID, AT5.ASYPOP_AH_END_VERSION_NBR,
  AT5.ASYPOP_AH_END_ITM_ID
...
select AT6AB.ASR_YEAR,
  ...
  STGA2.CHAR_VALUE as BASIS, STGA2.VERSION_NBR as STGA_VERSION_NBR_BASIS,
  STGA2.ITM_ID as STGA_ITM_ID_BASIS,
  AT6AB.IDPHPOP_START_VALUE, AT6AB.IDPHPOP_START_STC_ID, AT6AB.IDPHPOP_START_VERSION_NBR,
  AT6AB.IDPHPOP_START_ITM_ID,
  AT6AB.IDPHPOP_AH_START_VALUE, AT6AB.IDPHPOP_AH_START_STC_ID, AT6AB.IDPHPOP_AH_START_VERSION_NBR,
  AT6AB.IDPHPOP_AH_START_ITM_ID,
  AT6AB.IDPHNEW_VALUE, AT6AB.IDPHNEW_STC_ID, AT6AB.IDPHNEW_VERSION_NBR, AT6AB.IDPHNEW_ITM_ID,
  AT6AB.IDPHOTHINC_VALUE, AT6AB.IDPHOTHINC_STC_ID, AT6AB.IDPHOTHINC_VERSION_NBR,
  AT6AB.IDPHOTHINC_ITM_ID,
  AT6AB.IDPHRTN_VALUE, AT6AB.IDPHRTN_STC_ID, AT6AB.IDPHRTN_VERSION_NBR, AT6AB.IDPHRTN_ITM_ID,
  AT6AB.IDPHRTN_AH_VALUE, AT6AB.IDPHRTN_AH_STC_ID, AT6AB.IDPHRTN_AH_VERSION_NBR,
  AT6AB.IDPHRTN_AH_ITM_ID,
  AT6AB.IDPHRELOC_VALUE, AT6AB.IDPHRELOC_STC_ID, AT6AB.IDPHRELOC_VERSION_NBR,
  AT6AB.IDPHRELOC_ITM_ID,
  AT6AB.IDPHOTHDEC_VALUE, AT6AB.IDPHOTHDEC_STC_ID, AT6AB.IDPHOTHDEC_VERSION_NBR,
  AT6AB.IDPHOTHDEC_ITM_ID,
  AT6AB.IDPHPOP_END_VALUE, AT6AB.IDPHPOP_END_STC_ID, AT6AB.IDPHPOP_END_VERSION_NBR,
  AT6AB.IDPHPOP_END_ITM_ID,
  AT6AB.IDPHPOP_AH_END_VALUE, AT6AB.IDPHPOP_AH_END_STC_ID, AT6AB.IDPHPOP_AH_END_VERSION_NBR,
...
select AT6C.ASR_YEAR,
  ...
  nvl(LOCTV.DESCRIPTION, LOCT.DESCRIPTION) as LOC_TYPE_DESCRIPTION,
  AT6C.STG_ID_PRIMARY, STG.VERSION_NBR as STG_VERSION_NBR, STG.ITM_ID as STG_ITM_ID,
  STGA1.CHAR_VALUE as SOURCE, STGA1.VERSION_NBR as STGA_VERSION_NBR_SOURCE,
  STGA1.ITM_ID as STGA_ITM_ID_SOURCE,
  STGA2.CHAR_VALUE as BASIS, STGA2.VERSION_NBR as STGA_VERSION_NBR_BASIS,
  STGA2.ITM_ID as STGA_ITM_ID_BASIS,
  AT6C.IDPCPOP_START_VALUE, AT6C.IDPCPOP_START_STC_ID, AT6C.IDPCPOP_START_VERSION_NBR,
  AT6C.IDPCPOP_START_ITM_ID,
  AT6C.IDPCPOP_AH_START_VALUE, AT6C.IDPCPOP_AH_START_STC_ID, AT6C.IDPCPOP_AH_START_VERSION_NBR,
  AT6C.IDPCPOP_AH_START_ITM_ID,
  AT6C.IDPCNEW_VALUE, AT6C.IDPCNEW_STC_ID, AT6C.IDPCNEW_VERSION_NBR, AT6C.IDPCNEW_ITM_ID,
  AT6C.IDPCOTHINC_VALUE, AT6C.IDPCOTHINC_STC_ID, AT6C.IDPCOTHINC_VERSION_NBR,
  AT6C.IDPCOTHINC_ITM_ID,
  AT6C.IDPCRTN_VALUE, AT6C.IDPCRTN_STC_ID, AT6C.IDPCRTN_VERSION_NBR, AT6C.IDPCRTN_ITM_ID,
  AT6C.IDPCRTN_AH_VALUE, AT6C.IDPCRTN_AH_STC_ID, AT6C.IDPCRTN_AH_VERSION_NBR,
  AT6C.IDPCRTN_AH_ITM_ID,
  AT6C.IDPCRELOC_VALUE, AT6C.IDPCRELOC_STC_ID, AT6C.IDPCRELOC_VERSION_NBR, AT6C.IDPCRELOC_ITM_ID,
  AT6C.IDPCOTHDEC_VALUE, AT6C.IDPCOTHDEC_STC_ID, AT6C.IDPCOTHDEC_VERSION_NBR,
  AT6C.IDPCOTHDEC_ITM_ID,
  AT6C.IDPCPOP_END_VALUE, AT6C.IDPCPOP_END_STC_ID, AT6C.IDPCPOP_END_VERSION_NBR,
  AT6C.IDPCPOP_END_ITM_ID,
  AT6C.IDPCPOP_AH_END_VALUE, AT6C.IDPCPOP_AH_END_STC_ID, AT6C.IDPCPOP_AH_END_VERSION_NBR,
...
select AT6D.ASR_YEAR,
  ...
  nvl(LOCTV.DESCRIPTION, LOCT.DESCRIPTION) as LOC_TYPE_DESCRIPTION,
  AT6D.STG_ID_PRIMARY, STG.VERSION_NBR as STG_VERSION_NBR, STG.ITM_ID as STG_ITM_ID,
  STGA1.CHAR_VALUE as SOURCE, STGA1.VERSION_NBR as STGA_VERSION_NBR_SOURCE,
  STGA1.ITM_ID as STGA_ITM_ID_SOURCE,
  STGA2.CHAR_VALUE as BASIS, STGA2.VERSION_NBR as STGA_VERSION_NBR_BASIS,
  STGA2.ITM_ID as STGA_ITM_ID_BASIS,
  AT6D.IDPDPOP_START_VALUE, AT6D.IDPDPOP_START_STC_ID, AT6D.IDPDPOP_START_VERSION_NBR,
  AT6D.IDPDPOP_START_ITM_ID,
  AT6D.IDPDPOP_AH_START_VALUE, AT6D.IDPDPOP_AH_START_STC_ID, AT6D.IDPDPOP_AH_START_VERSION_NBR,
  AT6D.IDPDPOP_AH_START_ITM_ID,
  AT6D.IDPDNEW_VALUE, AT6D.IDPDNEW_STC_ID, AT6D.IDPDNEW_VERSION_NBR, AT6D.IDPDNEW_ITM_ID,
  AT6D.IDPDOTHINC_VALUE, AT6D.IDPDOTHINC_STC_ID, AT6D.IDPDOTHINC_VERSION_NBR,
  AT6D.IDPDOTHINC_ITM_ID,
  AT6D.IDPDRTN_VALUE, AT6D.IDPDRTN_STC_ID, AT6D.IDPDRTN_VERSION_NBR, AT6D.IDPDRTN_ITM_ID,
  AT6D.IDPDRTN_AH_VALUE, AT6D.IDPDRTN_AH_STC_ID, AT6D.IDPDRTN_AH_VERSION_NBR,
  AT6D.IDPDRTN_AH_ITM_ID,
  AT6D.IDPDRELOC_VALUE, AT6D.IDPDRELOC_STC_ID, AT6D.IDPDRELOC_VERSION_NBR, AT6D.IDPDRELOC_ITM_ID,
  AT6D.IDPDOTHDEC_VALUE, AT6D.IDPDOTHDEC_STC_ID, AT6D.IDPDOTHDEC_VERSION_NBR,
  AT6D.IDPDOTHDEC_ITM_ID,
  AT6D.IDPDPOP_END_VALUE, AT6D.IDPDPOP_END_STC_ID, AT6D.IDPDPOP_END_VERSION_NBR,
  AT6D.IDPDPOP_END_ITM_ID,
  AT6D.IDPDPOP_AH_END_VALUE, AT6D.IDPDPOP_AH_END_STC_ID, AT6D.IDPDPOP_AH_END_VERSION_NBR,
...
select AT7AB.ASR_YEAR,
  ...
  AT7AB.STG_ID_PRIMARY, STG.VERSION_NBR as STG_VERSION_NBR, STG.ITM_ID as STG_ITM_ID,
  STGA1.CHAR_VALUE as SOURCE, STGA1.VERSION_NBR as STGA_VERSION_NBR_SOURCE,
  STGA1.ITM_ID as STGA_ITM_ID_SOURCE,
  STGA2.CHAR_VALUE as BASIS, STGA2.VERSION_NBR as STGA_VERSION_NBR_BASIS,
  STGA2.ITM_ID as STGA_ITM_ID_BASIS,
  AT7AB.REFRTN_VALUE, AT7AB.REFRTN_STC_ID, AT7AB.REFRTN_VERSION_NBR, AT7AB.REFRTN_ITM_ID,
  AT7AB.REFRTN_AH_VALUE, AT7AB.REFRTN_AH_STC_ID, AT7AB.REFRTN_AH_VERSION_NBR, AT7AB.REFRTN_AH_ITM_ID
...
left outer join T_STATISTIC_GROUPS STG
  on STG.ID = AT7AB.STG_ID_PRIMARY
left outer join T_STC_GROUP_ATTRIBUTES STGA1
  on STGA1.STG_ID = STG.ID
  and STGA1.STGAT_CODE = 'SOURCE'
left outer join T_STC_GROUP_ATTRIBUTES STGA2
...
select AT7C.ASR_YEAR,
  ...
  AT7C.STG_ID_PRIMARY, STG.SUBGROUP_NAME as DESCRIPTION,
  STG.VERSION_NBR as STG_VERSION_NBR, STG.ITM_ID as STG_ITM_ID,
  STGA1.CHAR_VALUE as SOURCE, STGA1.VERSION_NBR as STGA_VERSION_NBR_SOURCE,
  STGA1.ITM_ID as STGA_ITM_ID_SOURCE,
  STGA2.CHAR_VALUE as BASIS, STGA2.VERSION_NBR as STGA_VERSION_NBR_BASIS,
  STGA2.ITM_ID as STGA_ITM_ID_BASIS,
  AT7C.STAPOP_START_VALUE, AT7C.STAPOP_START_STC_ID, AT7C.STAPOP_START_VERSION_NBR,
  AT7C.STAPOP_START_ITM_ID,
  AT7C.STAPOP_AH_START_VALUE, AT7C.STAPOP_AH_START_STC_ID, AT7C.STAPOP_AH_START_VERSION_NBR,
  AT7C.STAPOP_AH_START_ITM_ID,
  AT7C.NATLOSS_VALUE, AT7C.NATLOSS_STC_ID, AT7C.NATLOSS_VERSION_NBR, AT7C.NATLOSS_ITM_ID,
  AT7C.STAOTHINC_VALUE, AT7C.STAOTHINC_STC_ID, AT7C.STAOTHINC_VERSION_NBR, AT7C.STAOTHINC_ITM_ID,
  AT7C.NATACQ_VALUE, AT7C.NATACQ_STC_ID, AT7C.NATACQ_VERSION_NBR, AT7C.NATACQ_ITM_ID,
  AT7C.STAOTHDEC_VALUE, AT7C.STAOTHDEC_STC_ID, AT7C.STAOTHDEC_VERSION_NBR, AT7C.STAOTHDEC_ITM_ID,
  AT7C.STAPOP_END_VALUE, AT7C.STAPOP_END_STC_ID, AT7C.STAPOP_END_VERSION_NBR,
  AT7C.STAPOP_END_ITM_ID,
  AT7C.STAPOP_AH_END_VALUE, AT7C.STAPOP_AH_END_STC_ID, AT7C.STAPOP_AH_END_VERSION_NBR,
...
select AT7D.ASR_YEAR,
  ...
  cast(LOCA4.CHAR_VALUE as varchar2(3)) as UNHCR_ORIGIN_CODE,
  LOC2.NAME as LOC_NAME_ORIGIN_COUNTRY,
  AT7D.STG_ID_PRIMARY, STG.SUBGROUP_NAME as DESCRIPTION,
  STG.VERSION_NBR as STG_VERSION_NBR, STG.ITM_ID as STG_ITM_ID,
  STGA1.CHAR_VALUE as SOURCE, STGA1.VERSION_NBR as STGA_VERSION_NBR_SOURCE,
  STGA1.ITM_ID as STGA_ITM_ID_SOURCE,
  STGA2.CHAR_VALUE as BASIS, STGA2.VERSION_NBR as STGA_VERSION_NBR_BASIS,
  STGA2.ITM_ID as STGA_ITM_ID_BASIS,
  AT7D.OOCPOP_START_VALUE, AT7D.OOCPOP_START_STC_ID, AT7D.OOCPOP_START_VERSION_NBR,
  AT7D.OOCPOP_START_ITM_ID,
  AT7D.OOCPOP_AH_START_VALUE, AT7D.OOCPOP_AH_START_STC_ID, AT7D.OOCPOP_AH_START_VERSION_NBR,
  AT7D.OOCPOP_AH_START_ITM_ID,
  AT7D.OOCARR_VALUE, AT7D.OOCARR_STC_ID, AT7D.OOCARR_VERSION_NBR, AT7D.OOCARR_ITM_ID,
  AT7D.OOCOTHINC_VALUE, AT7D.OOCOTHINC_STC_ID, AT7D.OOCOTHINC_VERSION_NBR, AT7D.OOCOTHINC_ITM_ID,
  AT7D.OOCRTN_VALUE, AT7D.OOCRTN_STC_ID, AT7D.OOCRTN_VERSION_NBR, AT7D.OOCRTN_ITM_ID,
  AT7D.OOCOTHDEC_VALUE, AT7D.OOCOTHDEC_STC_ID, AT7D.OOCOTHDEC_VERSION_NBR, AT7D.OOCOTHDEC_ITM_ID,
  AT7D.OOCPOP_END_VALUE, AT7D.OOCPOP_END_STC_ID, AT7D.OOCPOP_END_VERSION_NBR,
  AT7D.OOCPOP_END_ITM_ID,
  AT7D.OOCPOP_AH_END_VALUE, AT7D.OOCPOP_AH_END_STC_ID, AT7D.OOCPOP_AH_END_VERSION_NBR,
