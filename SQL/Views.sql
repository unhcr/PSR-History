...
select AT2.ASR_YEAR,
  ...
  AT2.PGR_ID_PRIMARY, PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA1.VERSION_NBR as PGRA_VERSION_NBR_SOURCE,
  PGRA1.ITM_ID as PGRA_ITM_ID_SOURCE,
  PGRA2.CHAR_VALUE as BASIS, PGRA2.VERSION_NBR as PGRA_VERSION_NBR_BASIS,
  PGRA2.ITM_ID as PGRA_ITM_ID_BASIS,
...
select AT3.ASR_YEAR,
  ...
  AT3.PGR_ID_PRIMARY, PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
  PGRA.CHAR_VALUE as BASIS, PGRA.VERSION_NBR as PGRA_VERSION_NBR_BASIS,
  PGRA.ITM_ID as PGRA_ITM_ID_BASIS,
...
select AT4.ASR_YEAR,
  ...
  AT4.PGR_ID_PRIMARY, PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
...
with Q_ASR_TABLE5 as
 (select ASR_YEAR, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY, DIM_ID1, DIM_ID2, PGR_ID_PRIMARY,
  ...
  from
   (select to_char(extract(year from STC.START_DATE)) as ASR_YEAR,
      ...
      STC.DIM_ID1, STC.DIM_ID2, STC.PGR_ID_PRIMARY,
      replace(STC.STCT_CODE, '-', '_') ||
        case
          when extract(day from STC.END_DATE) = 2 then '_START'
          when extract(day from STC.START_DATE) = 31 then '_END'
...
select AT5.ASR_YEAR,
  ...
  cast(LOCA4.CHAR_VALUE as varchar2(3)) as UNHCR_ORIGIN_CODE,
  LOC2.NAME as LOC_NAME_ORIGIN_COUNTRY,
  AT5.PGR_ID_PRIMARY, PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
...
select AT6AB.ASR_YEAR,
  ...
  AT6AB.PGR_ID_PRIMARY, PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA1.VERSION_NBR as PGRA_VERSION_NBR_SOURCE,
  PGRA1.ITM_ID as PGRA_ITM_ID_SOURCE,
  PGRA2.CHAR_VALUE as BASIS, PGRA2.VERSION_NBR as PGRA_VERSION_NBR_BASIS,
  PGRA2.ITM_ID as PGRA_ITM_ID_BASIS,
...
left outer join T_POPULATION_GROUPS PGR
  on PGR.ID = AT6AB.PGR_ID_PRIMARY
left outer join T_POP_GROUP_ATTRIBUTES PGRA1
  on PGRA1.PGR_ID = PGR.ID
  and PGRA1.PGRAT_CODE = 'SOURCE'
left outer join T_POP_GROUP_ATTRIBUTES PGRA2
...
select AT6C.ASR_YEAR,
  ...
  nvl(LOCTV.DESCRIPTION, LOCT.DESCRIPTION) as LOC_TYPE_DESCRIPTION,
  AT6C.PGR_ID_PRIMARY, PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA1.VERSION_NBR as PGRA_VERSION_NBR_SOURCE,
  PGRA1.ITM_ID as PGRA_ITM_ID_SOURCE,
  PGRA2.CHAR_VALUE as BASIS, PGRA2.VERSION_NBR as PGRA_VERSION_NBR_BASIS,
  PGRA2.ITM_ID as PGRA_ITM_ID_BASIS,
...
select AT6D.ASR_YEAR,
  ...
  nvl(LOCTV.DESCRIPTION, LOCT.DESCRIPTION) as LOC_TYPE_DESCRIPTION,
  AT6D.PGR_ID_PRIMARY, PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA1.VERSION_NBR as PGRA_VERSION_NBR_SOURCE,
  PGRA1.ITM_ID as PGRA_ITM_ID_SOURCE,
  PGRA2.CHAR_VALUE as BASIS, PGRA2.VERSION_NBR as PGRA_VERSION_NBR_BASIS,
  PGRA2.ITM_ID as PGRA_ITM_ID_BASIS,
...
select AT7AB.ASR_YEAR,
  ...
  AT7AB.PGR_ID_PRIMARY, PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA1.VERSION_NBR as PGRA_VERSION_NBR_SOURCE,
  PGRA1.ITM_ID as PGRA_ITM_ID_SOURCE,
  PGRA2.CHAR_VALUE as BASIS, PGRA2.VERSION_NBR as PGRA_VERSION_NBR_BASIS,
  PGRA2.ITM_ID as PGRA_ITM_ID_BASIS,
...
left outer join T_POPULATION_GROUPS PGR
  on PGR.ID = AT7AB.PGR_ID_PRIMARY
left outer join T_POP_GROUP_ATTRIBUTES PGRA1
  on PGRA1.PGR_ID = PGR.ID
  and PGRA1.PGRAT_CODE = 'SOURCE'
left outer join T_POP_GROUP_ATTRIBUTES PGRA2
...
select AT7C.ASR_YEAR,
  ...
  AT7C.PGR_ID_PRIMARY, PGR.SUBGROUP_NAME as DESCRIPTION,
  PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA1.VERSION_NBR as PGRA_VERSION_NBR_SOURCE,
  PGRA1.ITM_ID as PGRA_ITM_ID_SOURCE,
  PGRA2.CHAR_VALUE as BASIS, PGRA2.VERSION_NBR as PGRA_VERSION_NBR_BASIS,
  PGRA2.ITM_ID as PGRA_ITM_ID_BASIS,
...
select AT7D.ASR_YEAR,
  ...
  cast(LOCA4.CHAR_VALUE as varchar2(3)) as UNHCR_ORIGIN_CODE,
  LOC2.NAME as LOC_NAME_ORIGIN_COUNTRY,
  AT7D.PGR_ID_PRIMARY, PGR.SUBGROUP_NAME as DESCRIPTION,
  PGR.VERSION_NBR as PGR_VERSION_NBR, PGR.ITM_ID as PGR_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA1.VERSION_NBR as PGRA_VERSION_NBR_SOURCE,
  PGRA1.ITM_ID as PGRA_ITM_ID_SOURCE,
  PGRA2.CHAR_VALUE as BASIS, PGRA2.VERSION_NBR as PGRA_VERSION_NBR_BASIS,
