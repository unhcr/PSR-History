...
with Q_ASR_TABLE2 as
 (select STATSYEAR, DST_CODE, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY, PGR_ID_PRIMARY,
...
select AT2.STATSYEAR,
  ...
  AT2.REFPOP_START_VALUE, AT2.REFPOP_START_STC_ID, AT2.REFPOP_START_ITM_ID,
  AT2.REFPOP_AH_START_VALUE, AT2.REFPOP_AH_START_STC_ID, AT2.REFPOP_AH_START_ITM_ID,
  AT2.ARR_GRP_VALUE, AT2.ARR_GRP_STC_ID, AT2.ARR_GRP_ITM_ID,
  AT2.ARR_IND_VALUE, AT2.ARR_IND_STC_ID, AT2.ARR_IND_ITM_ID,
  AT2.ARR_RESTL_VALUE, AT2.ARR_RESTL_STC_ID, AT2.ARR_RESTL_ITM_ID,
  AT2.BIRTH_VALUE, AT2.BIRTH_STC_ID, AT2.BIRTH_ITM_ID,
  AT2.REFOTHINC_VALUE, AT2.REFOTHINC_STC_ID, AT2.REFOTHINC_ITM_ID,
  case
  ...
  AT2.VOLREP_VALUE, AT2.VOLREP_STC_ID, AT2.VOLREP_ITM_ID,
  AT2.VOLREP_AH_VALUE, AT2.VOLREP_AH_STC_ID, AT2.VOLREP_AH_ITM_ID,
  AT2.RESTL_VALUE, AT2.RESTL_STC_ID, AT2.RESTL_ITM_ID,
  AT2.RESTL_AH_VALUE, AT2.RESTL_AH_STC_ID, AT2.RESTL_AH_ITM_ID,
  AT2.CESSATION_VALUE, AT2.CESSATION_STC_ID, AT2.CESSATION_ITM_ID,
  AT2.NATURLZN_VALUE, AT2.NATURLZN_STC_ID, AT2.NATURLZN_ITM_ID,
  AT2.DEATH_VALUE, AT2.DEATH_STC_ID, AT2.DEATH_ITM_ID,
  AT2.REFOTHDEC_VALUE, AT2.REFOTHDEC_STC_ID, AT2.REFOTHDEC_ITM_ID,
  case
  ...
  AT2.REFPOP_END_VALUE, AT2.REFPOP_END_STC_ID, AT2.REFPOP_END_ITM_ID,
  AT2.REFPOP_AH_END_VALUE, AT2.REFPOP_AH_END_STC_ID, AT2.REFPOP_AH_END_ITM_ID,
...
with Q_ASR_TABLE4 as
 (select STATSYEAR, DST_CODE, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY,
    UNCONV51_VALUE, UNCONV51_STC_ID, UNCONV51_ITM_ID,
    OAUCONV69_VALUE, OAUCONV69_STC_ID, OAUCONV69_ITM_ID,
    HCRSTAT_VALUE, HCRSTAT_STC_ID, HCRSTAT_ITM_ID,
    COMPPROT_VALUE, COMPPROT_STC_ID, COMPPROT_ITM_ID,
    TEMPPROT_VALUE, TEMPPROT_STC_ID, TEMPPROT_ITM_ID,
    OTHER_VALUE, OTHER_STC_ID, OTHER_ITM_ID,
    UNKNOWN_VALUE, UNKNOWN_STC_ID, UNKNOWN_ITM_ID
  from
   (select to_char(extract(year from STC.START_DATE)) as STATSYEAR, STC.DST_CODE,
...
select AT4.STATSYEAR,
  ...
  cast(LOCA4.CHAR_VALUE as varchar2(3)) as UNHCR_ORIGIN_CODE,
  LOC2.NAME as LOC_NAME_ORIGIN_COUNTRY,
  AT4.DST_CODE, DST.DESCRIPTION as DST_DESCRIPTION,
  AT4.UNCONV51_VALUE, AT4.UNCONV51_STC_ID, AT4.UNCONV51_ITM_ID,
  AT4.OAUCONV69_VALUE, AT4.OAUCONV69_STC_ID, AT4.OAUCONV69_ITM_ID,
  AT4.HCRSTAT_VALUE, AT4.HCRSTAT_STC_ID, AT4.HCRSTAT_ITM_ID,
  AT4.COMPPROT_VALUE, AT4.COMPPROT_STC_ID, AT4.COMPPROT_ITM_ID,
  AT4.TEMPPROT_VALUE, AT4.TEMPPROT_STC_ID, AT4.TEMPPROT_ITM_ID,
  AT4.OTHER_VALUE, AT4.OTHER_STC_ID, AT4.OTHER_ITM_ID,
  AT4.UNKNOWN_VALUE, AT4.UNKNOWN_STC_ID, AT4.UNKNOWN_ITM_ID,
  case
...
with Q_ASR_TABLE5 as
 (select STATSYEAR, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY, DIM_ID1, DIM_ID2,
    ASYPOP_START_VALUE, ASYPOP_START_STC_ID, ASYPOP_START_ITM_ID,
    ASYPOP_AH_START_VALUE, ASYPOP_AH_START_STC_ID, ASYPOP_AH_START_ITM_ID,
    ASYAPP_VALUE, ASYAPP_STC_ID, ASYAPP_ITM_ID,
    ASYREC_CV_VALUE, ASYREC_CV_STC_ID, ASYREC_CV_ITM_ID,
    ASYREC_CP_VALUE, ASYREC_CP_STC_ID, ASYREC_CP_ITM_ID,
    ASYREJ_VALUE, ASYREJ_STC_ID, ASYREJ_ITM_ID,
    ASYOTHCL_VALUE, ASYOTHCL_STC_ID, ASYOTHCL_ITM_ID,
    ASYPOP_END_VALUE, ASYPOP_END_STC_ID, ASYPOP_END_ITM_ID,
    ASYPOP_AH_END_VALUE, ASYPOP_AH_END_STC_ID, ASYPOP_AH_END_ITM_ID
  from
   (select to_char(extract(year from STC.START_DATE)) as STATSYEAR,
...
select AT5.STATSYEAR,
  ...
  cast(LOCA4.CHAR_VALUE as varchar2(3)) as UNHCR_ORIGIN_CODE,
  LOC2.NAME as LOC_NAME_ORIGIN_COUNTRY,
  AT5.ASYPOP_START_VALUE, AT5.ASYPOP_START_STC_ID, AT5.ASYPOP_START_ITM_ID,
  AT5.ASYPOP_AH_START_VALUE, AT5.ASYPOP_AH_START_STC_ID, AT5.ASYPOP_AH_START_ITM_ID,
  AT5.ASYAPP_VALUE, AT5.ASYAPP_STC_ID, AT5.ASYAPP_ITM_ID,
  AT5.ASYREC_CV_VALUE, AT5.ASYREC_CV_STC_ID, AT5.ASYREC_CV_ITM_ID,
  AT5.ASYREC_CP_VALUE, AT5.ASYREC_CP_STC_ID, AT5.ASYREC_CP_ITM_ID,
  AT5.ASYREJ_VALUE, AT5.ASYREJ_STC_ID, AT5.ASYREJ_ITM_ID,
  AT5.ASYOTHCL_VALUE, AT5.ASYOTHCL_STC_ID, AT5.ASYOTHCL_ITM_ID,
  AT5.ASYPOP_END_VALUE, AT5.ASYPOP_END_STC_ID, AT5.ASYPOP_END_ITM_ID,
  AT5.ASYPOP_AH_END_VALUE, AT5.ASYPOP_AH_END_STC_ID, AT5.ASYPOP_AH_END_ITM_ID
...
with Q_ASR_TABLE6AB as
 (select STATSYEAR, DST_CODE, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ASYLUM, DIM_ID1, PGR_ID_PRIMARY,
    IDPHPOP_START_VALUE, IDPHPOP_START_STC_ID, IDPHPOP_START_ITM_ID,
    IDPHPOP_AH_START_VALUE, IDPHPOP_AH_START_STC_ID, IDPHPOP_AH_START_ITM_ID,
    IDPHNEW_VALUE, IDPHNEW_STC_ID, IDPHNEW_ITM_ID,
    IDPHOTHINC_VALUE, IDPHOTHINC_STC_ID, IDPHOTHINC_ITM_ID,
    IDPHRTN_VALUE, IDPHRTN_STC_ID, IDPHRTN_ITM_ID,
    IDPHRTN_AH_VALUE, IDPHRTN_AH_STC_ID, IDPHRTN_AH_ITM_ID,
    IDPHRELOC_VALUE, IDPHRELOC_STC_ID, IDPHRELOC_ITM_ID,
    IDPHOTHDEC_VALUE, IDPHOTHDEC_STC_ID, IDPHOTHDEC_ITM_ID,
    IDPHPOP_END_VALUE, IDPHPOP_END_STC_ID, IDPHPOP_END_ITM_ID,
    IDPHPOP_AH_END_VALUE, IDPHPOP_AH_END_STC_ID, IDPHPOP_AH_END_ITM_ID
  from
   (select to_char(extract(year from STC.START_DATE)) as STATSYEAR, STC.DST_CODE,
...
Q_DISPLACEMENT_STATUSES as
 (select CODE, DESCRIPTION
  ...
  where RANK = 1)
--
select AT6AB.STATSYEAR,
  cast(LOCA1.CHAR_VALUE as varchar2(3)) as ISO_COUNTRY_CODE,
  cast(LOCA2.CHAR_VALUE as varchar2(3)) as UNHCR_COUNTRY_CODE,
  LOC1.NAME as LOC_NAME_ASYLUM_COUNTRY,
  AT6AB.DST_CODE, DST.DESCRIPTION as DST_DESCRIPTION,
  LOC2.NAME as LOC_NAME_ASYLUM, nvl(LOCTV.DESCRIPTION, LOCT.DESCRIPTION) as LOC_TYPE_DESCRIPTION,
  DIM.CODE as OFFICIAL_CODE, DIM.DESCRIPTION as OFFICIAL_DESCRIPTION,
  AT6AB.IDPHPOP_START_VALUE, AT6AB.IDPHPOP_START_STC_ID, AT6AB.IDPHPOP_START_ITM_ID,
  AT6AB.IDPHPOP_AH_START_VALUE, AT6AB.IDPHPOP_AH_START_STC_ID, AT6AB.IDPHPOP_AH_START_ITM_ID,
  AT6AB.IDPHNEW_VALUE, AT6AB.IDPHNEW_STC_ID, AT6AB.IDPHNEW_ITM_ID,
  AT6AB.IDPHOTHINC_VALUE, AT6AB.IDPHOTHINC_STC_ID, AT6AB.IDPHOTHINC_ITM_ID,
  AT6AB.IDPHRTN_VALUE, AT6AB.IDPHRTN_STC_ID, AT6AB.IDPHRTN_ITM_ID,
  AT6AB.IDPHRTN_AH_VALUE, AT6AB.IDPHRTN_AH_STC_ID, AT6AB.IDPHRTN_AH_ITM_ID,
  AT6AB.IDPHRELOC_VALUE, AT6AB.IDPHRELOC_STC_ID, AT6AB.IDPHRELOC_ITM_ID,
  AT6AB.IDPHOTHDEC_VALUE, AT6AB.IDPHOTHDEC_STC_ID, AT6AB.IDPHOTHDEC_ITM_ID,
  AT6AB.IDPHPOP_END_VALUE, AT6AB.IDPHPOP_END_STC_ID, AT6AB.IDPHPOP_END_ITM_ID,
  AT6AB.IDPHPOP_AH_END_VALUE, AT6AB.IDPHPOP_AH_END_STC_ID, AT6AB.IDPHPOP_AH_END_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA2.CHAR_VALUE as BASIS
...
with Q_ASR_TABLE6C as
 (select STATSYEAR, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ASYLUM, PGR_ID_PRIMARY,
    IDPCPOP_START_VALUE, IDPCPOP_START_STC_ID, IDPCPOP_START_ITM_ID,
    IDPCPOP_AH_START_VALUE, IDPCPOP_AH_START_STC_ID, IDPCPOP_AH_START_ITM_ID,
    IDPCNEW_VALUE, IDPCNEW_STC_ID, IDPCNEW_ITM_ID,
    IDPCOTHINC_VALUE, IDPCOTHINC_STC_ID, IDPCOTHINC_ITM_ID,
    IDPCRTN_VALUE, IDPCRTN_STC_ID, IDPCRTN_ITM_ID,
    IDPCRTN_AH_VALUE, IDPCRTN_AH_STC_ID, IDPCRTN_AH_ITM_ID,
    IDPCRELOC_VALUE, IDPCRELOC_STC_ID, IDPCRELOC_ITM_ID,
    IDPCOTHDEC_VALUE, IDPCOTHDEC_STC_ID, IDPCOTHDEC_ITM_ID,
    IDPCPOP_END_VALUE, IDPCPOP_END_STC_ID, IDPCPOP_END_ITM_ID,
    IDPCPOP_AH_END_VALUE, IDPCPOP_AH_END_STC_ID, IDPCPOP_AH_END_ITM_ID
  from
   (select to_char(extract(year from STC.START_DATE)) as STATSYEAR,
...
Q_LOCATION_TYPE_VARIANTS as
 (select ID, DESCRIPTION
  ...
  where RANK = 1)
--
select AT6C.STATSYEAR,
  cast(LOCA1.CHAR_VALUE as varchar2(3)) as ISO_COUNTRY_CODE,
  cast(LOCA2.CHAR_VALUE as varchar2(3)) as UNHCR_COUNTRY_CODE,
  LOC1.NAME as LOC_NAME_ASYLUM_COUNTRY,
  LOC2.NAME as LOC_NAME_ASYLUM, nvl(LOCTV.DESCRIPTION, LOCT.DESCRIPTION) as LOC_TYPE_DESCRIPTION,
  AT6C.IDPCPOP_START_VALUE, AT6C.IDPCPOP_START_STC_ID, AT6C.IDPCPOP_START_ITM_ID,
  AT6C.IDPCPOP_AH_START_VALUE, AT6C.IDPCPOP_AH_START_STC_ID, AT6C.IDPCPOP_AH_START_ITM_ID,
  AT6C.IDPCNEW_VALUE, AT6C.IDPCNEW_STC_ID, AT6C.IDPCNEW_ITM_ID,
  AT6C.IDPCOTHINC_VALUE, AT6C.IDPCOTHINC_STC_ID, AT6C.IDPCOTHINC_ITM_ID,
  AT6C.IDPCRTN_VALUE, AT6C.IDPCRTN_STC_ID, AT6C.IDPCRTN_ITM_ID,
  AT6C.IDPCRTN_AH_VALUE, AT6C.IDPCRTN_AH_STC_ID, AT6C.IDPCRTN_AH_ITM_ID,
  AT6C.IDPCRELOC_VALUE, AT6C.IDPCRELOC_STC_ID, AT6C.IDPCRELOC_ITM_ID,
  AT6C.IDPCOTHDEC_VALUE, AT6C.IDPCOTHDEC_STC_ID, AT6C.IDPCOTHDEC_ITM_ID,
  AT6C.IDPCPOP_END_VALUE, AT6C.IDPCPOP_END_STC_ID, AT6C.IDPCPOP_END_ITM_ID,
  AT6C.IDPCPOP_AH_END_VALUE, AT6C.IDPCPOP_AH_END_STC_ID, AT6C.IDPCPOP_AH_END_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA2.CHAR_VALUE as BASIS
...
with Q_ASR_TABLE6D as
 (select STATSYEAR, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ASYLUM, PGR_ID_PRIMARY,
    IDPDPOP_START_VALUE, IDPDPOP_START_STC_ID, IDPDPOP_START_ITM_ID,
    IDPDPOP_AH_START_VALUE, IDPDPOP_AH_START_STC_ID, IDPDPOP_AH_START_ITM_ID,
    IDPDNEW_VALUE, IDPDNEW_STC_ID, IDPDNEW_ITM_ID,
    IDPDOTHINC_VALUE, IDPDOTHINC_STC_ID, IDPDOTHINC_ITM_ID,
    IDPDRTN_VALUE, IDPDRTN_STC_ID, IDPDRTN_ITM_ID,
    IDPDRTN_AH_VALUE, IDPDRTN_AH_STC_ID, IDPDRTN_AH_ITM_ID,
    IDPDRELOC_VALUE, IDPDRELOC_STC_ID, IDPDRELOC_ITM_ID,
    IDPDOTHDEC_VALUE, IDPDOTHDEC_STC_ID, IDPDOTHDEC_ITM_ID,
    IDPDPOP_END_VALUE, IDPDPOP_END_STC_ID, IDPDPOP_END_ITM_ID,
    IDPDPOP_AH_END_VALUE, IDPDPOP_AH_END_STC_ID, IDPDPOP_AH_END_ITM_ID
  from
   (select to_char(extract(year from STC.START_DATE)) as STATSYEAR,
      STC.LOC_ID_ASYLUM_COUNTRY, STC.LOC_ID_ASYLUM, STC.PGR_ID_PRIMARY,
      replace(STC.STCT_CODE, '-', '_') ||
...
Q_LOCATION_TYPE_VARIANTS as
 (select ID, DESCRIPTION
  ...
  where RANK = 1)
--
select AT6D.STATSYEAR,
  cast(LOCA1.CHAR_VALUE as varchar2(3)) as ISO_COUNTRY_CODE,
  cast(LOCA2.CHAR_VALUE as varchar2(3)) as UNHCR_COUNTRY_CODE,
  LOC1.NAME as LOC_NAME_ASYLUM_COUNTRY,
  LOC2.NAME as LOC_NAME_ASYLUM, nvl(LOCTV.DESCRIPTION, LOCT.DESCRIPTION) as LOC_TYPE_DESCRIPTION,
  AT6D.IDPDPOP_START_VALUE, AT6D.IDPDPOP_START_STC_ID, AT6D.IDPDPOP_START_ITM_ID,
  AT6D.IDPDPOP_AH_START_VALUE, AT6D.IDPDPOP_AH_START_STC_ID, AT6D.IDPDPOP_AH_START_ITM_ID,
  AT6D.IDPDNEW_VALUE, AT6D.IDPDNEW_STC_ID, AT6D.IDPDNEW_ITM_ID,
  AT6D.IDPDOTHINC_VALUE, AT6D.IDPDOTHINC_STC_ID, AT6D.IDPDOTHINC_ITM_ID,
  AT6D.IDPDRTN_VALUE, AT6D.IDPDRTN_STC_ID, AT6D.IDPDRTN_ITM_ID,
  AT6D.IDPDRTN_AH_VALUE, AT6D.IDPDRTN_AH_STC_ID, AT6D.IDPDRTN_AH_ITM_ID,
  AT6D.IDPDRELOC_VALUE, AT6D.IDPDRELOC_STC_ID, AT6D.IDPDRELOC_ITM_ID,
  AT6D.IDPDOTHDEC_VALUE, AT6D.IDPDOTHDEC_STC_ID, AT6D.IDPDOTHDEC_ITM_ID,
  AT6D.IDPDPOP_END_VALUE, AT6D.IDPDPOP_END_STC_ID, AT6D.IDPDPOP_END_ITM_ID,
  AT6D.IDPDPOP_AH_END_VALUE, AT6D.IDPDPOP_AH_END_STC_ID, AT6D.IDPDPOP_AH_END_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA2.CHAR_VALUE as BASIS
...
with Q_ASR_TABLE7AB as
 (select STATSYEAR, DST_CODE, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY, PGR_ID_PRIMARY,
    REFRTN_VALUE, REFRTN_STC_ID, REFRTN_ITM_ID,
    REFRTN_AH_VALUE, REFRTN_AH_STC_ID, REFRTN_AH_ITM_ID
  from
   (select to_char(extract(year from STC.START_DATE)) as STATSYEAR, STC.DST_CODE,
      STC.LOC_ID_ASYLUM_COUNTRY, STC.LOC_ID_ORIGIN_COUNTRY, STC.PGR_ID_PRIMARY,
...
select AT7AB.STATSYEAR,
  ...
  AT7AB.DST_CODE, DST.DESCRIPTION as DST_DESCRIPTION,
  ...
  AT7AB.REFRTN_VALUE, AT7AB.REFRTN_STC_ID, AT7AB.REFRTN_ITM_ID,
  AT7AB.REFRTN_AH_VALUE, AT7AB.REFRTN_AH_STC_ID, AT7AB.REFRTN_AH_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA2.CHAR_VALUE as BASIS
...
with Q_ASR_TABLE7C as
 (select STATSYEAR, DST_CODE, LOC_ID_ASYLUM_COUNTRY, PGR_ID_PRIMARY,
    STAPOP_START_VALUE, STAPOP_START_STC_ID, STAPOP_START_ITM_ID,
    STAPOP_AH_START_VALUE, STAPOP_AH_START_STC_ID, STAPOP_AH_START_ITM_ID,
    NATLOSS_VALUE, NATLOSS_STC_ID, NATLOSS_ITM_ID,
    STAOTHINC_VALUE, STAOTHINC_STC_ID, STAOTHINC_ITM_ID,
    NATACQ_VALUE, NATACQ_STC_ID, NATACQ_ITM_ID,
    STAOTHDEC_VALUE, STAOTHDEC_STC_ID, STAOTHDEC_ITM_ID,
    STAPOP_END_VALUE, STAPOP_END_STC_ID, STAPOP_END_ITM_ID,
    STAPOP_AH_END_VALUE, STAPOP_AH_END_STC_ID, STAPOP_AH_END_ITM_ID
  from
   (select to_char(extract(year from STC.START_DATE)) as STATSYEAR, STC.DST_CODE,
      STC.LOC_ID_ASYLUM_COUNTRY, STC.LOC_ID_ORIGIN_COUNTRY, STC.PGR_ID_PRIMARY,
      replace(STC.STCT_CODE, '-', '_') ||
...
Q_LOCATIONS as
 (select ID, NAME
  ...
  where RANK = 1)
--
select AT7C.STATSYEAR,
  cast(LOCA1.CHAR_VALUE as varchar2(3)) as ISO_COUNTRY_CODE,
  cast(LOCA2.CHAR_VALUE as varchar2(3)) as UNHCR_COUNTRY_CODE,
  LOC.NAME as LOC_NAME_ASYLUM_COUNTRY,
  PGR.SUBGROUP_NAME as DESCRIPTION,
  AT7C.STAPOP_START_VALUE, AT7C.STAPOP_START_STC_ID, AT7C.STAPOP_START_ITM_ID,
  AT7C.STAPOP_AH_START_VALUE, AT7C.STAPOP_AH_START_STC_ID, AT7C.STAPOP_AH_START_ITM_ID,
  AT7C.NATLOSS_VALUE, AT7C.NATLOSS_STC_ID, AT7C.NATLOSS_ITM_ID,
  AT7C.STAOTHINC_VALUE, AT7C.STAOTHINC_STC_ID, AT7C.STAOTHINC_ITM_ID,
  AT7C.NATACQ_VALUE, AT7C.NATACQ_STC_ID, AT7C.NATACQ_ITM_ID,
  AT7C.STAOTHDEC_VALUE, AT7C.STAOTHDEC_STC_ID, AT7C.STAOTHDEC_ITM_ID,
  AT7C.STAPOP_END_VALUE, AT7C.STAPOP_END_STC_ID, AT7C.STAPOP_END_ITM_ID,
  AT7C.STAPOP_AH_END_VALUE, AT7C.STAPOP_AH_END_STC_ID, AT7C.STAPOP_AH_END_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA2.CHAR_VALUE as BASIS
...
with Q_ASR_TABLE7D as
 (select STATSYEAR, DST_CODE, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY, PGR_ID_PRIMARY,
    OOCPOP_START_VALUE, OOCPOP_START_STC_ID, OOCPOP_START_ITM_ID,
    OOCPOP_AH_START_VALUE, OOCPOP_AH_START_STC_ID, OOCPOP_AH_START_ITM_ID,
    OOCARR_VALUE, OOCARR_STC_ID, OOCARR_ITM_ID,
    OOCOTHINC_VALUE, OOCOTHINC_STC_ID, OOCOTHINC_ITM_ID,
    OOCRTN_VALUE, OOCRTN_STC_ID, OOCRTN_ITM_ID,
    OOCOTHDEC_VALUE, OOCOTHDEC_STC_ID, OOCOTHDEC_ITM_ID,
    OOCPOP_END_VALUE, OOCPOP_END_STC_ID, OOCPOP_END_ITM_ID,
    OOCPOP_AH_END_VALUE, OOCPOP_AH_END_STC_ID, OOCPOP_AH_END_ITM_ID
  from
   (select to_char(extract(year from STC.START_DATE)) as STATSYEAR, STC.DST_CODE,
      STC.LOC_ID_ASYLUM_COUNTRY, STC.LOC_ID_ORIGIN_COUNTRY, STC.PGR_ID_PRIMARY,
      replace(STC.STCT_CODE, '-', '_') ||
...
select AT7D.STATSYEAR,
  ...
  LOC2.NAME as LOC_NAME_ORIGIN_COUNTRY,
  PGR.SUBGROUP_NAME as DESCRIPTION,
  AT7D.OOCPOP_START_VALUE, AT7D.OOCPOP_START_STC_ID, AT7D.OOCPOP_START_ITM_ID,
  AT7D.OOCPOP_AH_START_VALUE, AT7D.OOCPOP_AH_START_STC_ID, AT7D.OOCPOP_AH_START_ITM_ID,
  AT7D.OOCARR_VALUE, AT7D.OOCARR_STC_ID, AT7D.OOCARR_ITM_ID,
  AT7D.OOCOTHINC_VALUE, AT7D.OOCOTHINC_STC_ID, AT7D.OOCOTHINC_ITM_ID,
  AT7D.OOCRTN_VALUE, AT7D.OOCRTN_STC_ID, AT7D.OOCRTN_ITM_ID,
  AT7D.OOCOTHDEC_VALUE, AT7D.OOCOTHDEC_STC_ID, AT7D.OOCOTHDEC_ITM_ID,
  AT7D.OOCPOP_END_VALUE, AT7D.OOCPOP_END_STC_ID, AT7D.OOCPOP_END_ITM_ID,
  AT7D.OOCPOP_AH_END_VALUE, AT7D.OOCPOP_AH_END_STC_ID, AT7D.OOCPOP_AH_END_ITM_ID,
  PGRA1.CHAR_VALUE as SOURCE, PGRA2.CHAR_VALUE as BASIS
...
with Q_TPOC as
 (select STATSYEAR, LOC_ID_ASYLUM_COUNTRY,
  ...
  from
   (select STATSYEAR, LOC_ID_ASYLUM_COUNTRY, LOC_ID_ORIGIN_COUNTRY,
      ...
      OOCPOP_OOC_VALUE
    from
     (select to_char(extract(year from START_DATE)) as STATSYEAR,
        case
          when STCT_CODE in ('VOLREP', 'REFRTN') then LOC_ID_ORIGIN_COUNTRY
          else LOC_ID_ASYLUM_COUNTRY
        end as LOC_ID_ASYLUM_COUNTRY,
        case
          when STCT_CODE in ('VOLREP', 'REFRTN') then LOC_ID_ASYLUM_COUNTRY
          else LOC_ID_ORIGIN_COUNTRY
        end as LOC_ID_ORIGIN_COUNTRY,
        replace(STCT_CODE, '-', '_') || '_' || DST_CODE as COLUMN_NAME,
        VALUE
      from T_STATISTICS
      where extract(day from END_DATE) = 1
      and (STCT_CODE, DST_CODE) in
       (('REFPOP', 'REF'),
        ('REFPOP-AH', 'REF'),
        ('REFPOP', 'ROC'),
        ('REFPOP-AH', 'ROC'),
  ...
  group by STATSYEAR, LOC_ID_ASYLUM_COUNTRY),
--
Q_LOCATIONS as
 (select ID, NAME
  from
